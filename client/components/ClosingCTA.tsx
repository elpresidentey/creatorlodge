      ...
      <div className="lounge-container section-pad">
        ...
        <div className="relative flex flex-col justify-between gap-8 overflow-hidden rounded-[24px] border border-[#C6A15B]/30 bg-gradient-to-br from-[#171510] via-[#121110] to-[#0C0C0D] p-8 shadow-[0_32px_80px_rgba(0,0,0,0.5)] transition-all duration-700 hover:border-[#C6A15B]/50 md:flex-row md:items-center md:p-14">
          ...
          <div className="relative flex shrink-0 flex-wrap items-center gap-3">
            <Link to="/book" className="btn-shine pressable inline-flex h-[52px] items-center justify-center rounded-[10px] border border-[#E8C77A]/40 bg-gradient-to-b from-[#E8C77A] to-[#C6A15B] px-8 text-[13px] font-semibold uppercase tracking-[0.1em] text-[#171410] shadow-[0_12px_40px_rgba(212,168,75,0.45),0_0_20px_rgba(212,168,75,0.2),inset_0_1px_0_rgba(255,255,255,0.5)] hover:brightness-110">Reserve a space</Link>
            <Link to="/contact" className="pressable inline-flex h-[52px] items-center justify-center rounded-[10px] border border-[#C6A15B]/40 bg-white/[0.08] px-8 text-[13px] font-medium uppercase tracking-[0.1em] text-ivory transition hover:border-[#C6A15B]/60 hover:bg-white/15">Speak to us</Link>
          </div>
        </div>
        </Reveal>
      </div>
