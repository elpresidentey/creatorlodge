        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4 lg:gap-6">
          {outlets.map((o, i) => (
            ...
            <Link to={`/outlets/${o.slug}`} className="group card-lift pressable relative block aspect-[3/4] overflow-hidden rounded-[20px] border border-[#C6A15B]/20 shadow-[0_24px_60px_rgba(23,20,16,0.25)] hover:border-[#C6A15B]/55 hover:shadow-[0_32px_80px_rgba(23,20,16,0.35)]">
              <img src={o.image} alt={o.name} loading="lazy" className="absolute inset-0 h-full w-full object-cover transition duration-[1200ms] group-hover:scale-[1.06]" />
              ...
              <div className="absolute inset-x-0 bottom-0 p-5">
                <h3 className="font-display text-[20px] font-medium leading-tight text-ivory">{o.name}</h3>
                <p className="mt-1.5 font-display text-[12px] italic leading-snug text-gold-soft/90">{o.address}</p>
